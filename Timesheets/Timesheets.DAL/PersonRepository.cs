...
namespace Timesheets.DAL
{
    ...
    {
        private static readonly List<Person> _dataContext = new List<Person>()
        {
        ...
        {
            return _dataContext.FirstOrDefault(p => p.Id == id);
        }
        ...
        public IPerson Create(PersonCreateDTO input)
        {
            int newId = _dataContext.Count();
        ...
        {
            var entity = _dataContext.FirstOrDefault(i => i.Id == id);
            if (entity != null)
            {
        ...
        public IPerson Update(PersonEditDTO input)
        {
            var entity = _dataContext.FirstOrDefault(i => i.Id == input.Id);
            if (entity != null)
            {
